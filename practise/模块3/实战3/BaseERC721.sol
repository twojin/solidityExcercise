...
contract BaseERC721 {
    ...
    function tokenURI(uint256 tokenId) public view returns (string memory) {
        require(
            /**code*/_owners[tokenId] != address(0),
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            /**code*/ owner == msg.sender || isApprovedForAll(owner, msg.sender),
    ...
    function _isApprovedOrOwner(
        ...
        /**code*/
        return spender == _owners[tokenId] || spender == _tokenApprovals[tokenId] || true == _operatorApprovals[_owners[tokenId]][spender];
    }
